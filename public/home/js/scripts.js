...
jQuery(function ($) {
    ...
    function submitMSG(valid, parentSelector) {
        if (valid) {
            ...
            $(parentSelector + " .message-box div").removeClass('alert-danger').addClass('alert-success').text('We have received your request. We will get back to you soon.');
        } else {
            $(parentSelector + " .message-box").removeClass('d-none').addClass('d-block ');
            $(parentSelector + " .message-box div").removeClass('alert-success').addClass('alert-danger').text('Please put valid information');
        }
    }
